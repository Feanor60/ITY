...
\begin{quotation}
\textsf{\largeČím více druhů}, \textsc{řezů}, \texttt{\tiny velikostí}, barev písma a \underline {jiných efektů} použijeme, tím \textit{\large profesionálněji} bude dokument vypadat. Čtenář tím bude vždy \textsc{nadšen}!
\end{quotation}
